...
<template>
  <div class="fixed inset-0 z-50 hidden bg-black bg-opacity-50">
    <aside class="z-20 max-h-screen w-64 overflow-auto bg-white">
      ...
      <section class="border-b py-2">
        <ul>
          <li>
            <a
              href="#"
              class="flex items-center bg-gray-200 px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="mr-6 h-6 w-6 text-red-600"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
      ...
      <section class="border-b px-8 py-4">
        <span class="text-sm font-medium leading-5"
          >Sign in to like videos comment, and subscribe</span
        >
        <button
          class="mt-3 flex items-center rounded-sm border border-blue-700 px-2 py-0.5 text-sm uppercase text-blue-700"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="mr-2 h-7 w-7"
      ...
      <section class="border-b py-2">
        <div class="mr-6 px-6 py-2 text-sm font-bold uppercase">Best of youtube</div>
        <ul>
          <li>
            <a href="#" class="flex items-center px-6 py-2 text-sm hover:bg-gray-100">
              <div class="mr-6 rounded-full bg-gray-700 p-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <ul>
          <li>
            <a href="#" class="flex items-center px-6 py-2 text-sm hover:bg-gray-100">
              ...
              <span>Browse chanel</span>
            </a>
          </li>
        </ul>
      </section>
      <section class="border-b py-2">
        <div class="mr-6 px-6 py-2 text-sm font-bold uppercase">More from youtube</div>
        <ul>
          <li>
            <a href="#" class="flex items-center px-6 py-2 text-sm hover:bg-gray-100">
              <svg
      ...
      <section class="space-y-4 px-6 py-4 text-xs font-semibold">
        <div>
        ...
        <div class="font-normal text-gray-500">&copy; Google LLC 2024</div>
      </section>
    </aside>
  </div>
</template>
